...
const SavingsGoalCard = ({
    ...
    const handleAddFunds = async () => {
        ...
        try {
            ...
            Alert.alert(
                "Error",
                "Failed to add funds to goal. Please try again."
            );
        }
    };
    ...
    const handleUpdateGoal = async () => {
        ...
        try {
            ...
            Alert.alert(
                "Error",
                "Failed to update goal details. Please try again."
            );
        }
    };
