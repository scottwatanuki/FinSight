...
const { addGoal } = require("../backend/pushData");
const CircularProgress = require("../../components/CircularProgress");
const SpendingBarChart = require("../../components/SpendingBarChart");
const MonthlySpendingChart = require("../../components/MonthlySpendingChart");
const SavingsGoalCard = require("../components/SavingsGoalCard");
const FinancialInsightsCard = require("../../components/FinancialInsightsCard");
const { useSpendingData } = require("../../hooks/useSpendingData");
